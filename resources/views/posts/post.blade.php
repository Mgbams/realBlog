                    ...
                    <div class="row">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="post_title" class="col-md-4 col-form-label text-md-right">post_title</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="post_body" rows="7" type="text" class="form-control @error('post_body') is-invalid @enderror" name="post_body" value="{{ old('post_body') }}" required autocomplete="post_body"></textarea>
